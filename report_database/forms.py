...
class ReportForm(forms.Form):
    ...
    date = forms.DateField(widget=SelectDateWidget(years=[ str(k) for k in range(2000,2051)]))
    sdesc = forms.CharField(label='Short Description', max_length=60)
    ldesc = forms.CharField(label='Long Description', widget=forms.Textarea, max_length=1000)
